...
export function VibeDashboard() {
  ...
  const { response, imageThumbnail } = currentResult;
    ...
    <div className="flex flex-col gap-4">
      <div className="flex justify-between items-center px-4">
        ...
        <button
          ...
          className="flex items-center gap-2 px-4 py-2 bg-white/50 dark:bg-white/10 hover:bg-white/80 dark:hover:bg-white/20 backdrop-blur-md border border-white/20 rounded-full text-xs font-bold transition-all active:scale-95 shadow-sm group cursor-pointer"
        >
          ...
          <div className="w-full lg:w-2/5 flex flex-col gap-6">
            ...
            <div className="bg-theme-cream p-4 rounded-xl">
              ...
              <div className="flex gap-2 h-16 rounded-lg overflow-hidden shadow-inner">
                {response.colorPalette?.map((color, i) => (
                  <button 
                    key={i} 
